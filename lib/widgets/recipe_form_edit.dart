...
//             TextField(
//               controller: titleController,
//               decoration: InputDecoration(labelText: 'Назва рецепту'),
//             ),
//             TextField(
//               controller: descriptionController,
//               decoration: InputDecoration(labelText: 'Опис рецепту'),
//             ),
//             ElevatedButton(
//               onPressed: () {
//                 final updatedRecipe = Recipe(
...
//                 );
//
//                 recipeProvider.updateRecipe(recipe.key, updatedRecipe);
